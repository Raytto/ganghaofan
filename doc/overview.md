...
## 全局主题与样式
- 背景：页面底色 `#1B1B1B`；标题栏背景 `#1B1B1B`；日历单元格底 `#131314`。
- 文字：主文字 `#C9D1D9`；次级说明 `#8b949e`；错误红 `#f85149`。
- 边框：浅色分隔 `rgba(255,255,255,0.08~0.12)`。
- 组件：navigation-bar 默认背景 `#1B1B1B`、文字 `#C9D1D9`，返回箭头跟随 `currentColor`。
